...
<div class="bg-yellow-50 min-h-screen py-8 px-6">
    <div class="max-w-4xl mx-auto bg-white p-6 rounded-lg shadow-md">
        <h2 class="text-2xl font-semibold text-gray-800 mb-4">Nieuw Product</h2>
        ...
        <form method="POST" action="{{ route('products.store') }}" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="name" name="name" value="{{ old('name') }}" class="block w-full border-gray-300 rounded-md shadow-sm" required>
            </div>

            <!-- Product Beschrijving -->
            <div class="mb-4">
                <label for="description" class="block text-gray-700 font-semibold">Beschrijving</label>
                <textarea id="description" name="description" class="block w-full border-gray-300 rounded-md shadow-sm">{{ old('description') }}</textarea>
            </div>

            <!-- Product Prijs -->
            <div class="mb-4">
                <label for="price" class="block text-gray-700 font-semibold">Prijs</label>
                <input type="text" id="price" name="price" value="{{ old('price') }}" class="block w-full border-gray-300 rounded-md shadow-sm" required>
            </div>
